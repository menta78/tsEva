...
load testcase_trivariate %water level data of two stations in the Adriatic Sea plut another one from the Dutch coasts
...
hl=legend('Series1','Series2','Series3','JointPk1','JointPk2','JointPk3','JointNpk1','JointNpk2','JointNpk3','Thr1','Thr2','Thr3','Peaks');
