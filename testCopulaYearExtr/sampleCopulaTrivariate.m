...
[retLev, jpdf, cplParam] = tsCopulaYearExtrFit(retPeriod, retLev, yMax, 'copulafamily', 'gaussian');
...
[retLev, jpdf, cplParam, jcdf] = tsCopulaYearExtrFit(retPeriod, retLev, yMax, 'copulafamily', 'gaussian', 'computeCdf', true);
