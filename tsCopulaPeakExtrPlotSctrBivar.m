function [handles] = tsCopulaPeakExtrPlotSctrBivar(monteCarloRsmpl, yMaxLevel, varargin)
...
lgnd = legend([ymaxSctr, rsmplSctrObj], {'Peaks', ['Joint Distribution' newline 'Montecarlo']}, 'fontsize', fontSize);
